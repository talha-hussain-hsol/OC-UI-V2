...
import ExpiringDocuments from "../../pages/compliancePortal/complianceScreens/ExpiringDocuments";
import PeriodicReview from "../../pages/compliancePortal/complianceScreens/PeriodicReviewFundAccount";
import QuickScan from "../../pages/compliancePortal/complianceScreens/QuickScanCompliance";
import DueDilligenceScreen from "../../pages/compliancePortal/complianceScreens/DueDilligenceScreen";
...
const FundAccountCard = () => {
  ...
  const renderContent = () => {
    if (selectedTab === "Accounts" || tabIndex === 0) {
      return (
          <div>
      ...
      else if (selectedTab === "Due Diligence" || tabIndex === 3) {
