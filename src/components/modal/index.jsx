...
function DynamicModal({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 ">
      ...
      <div
        className={`relative bg-color-modal-${theme} rounded-lg shadow-lg mx-4 ${className} 
        animate-slideDown`}
        style={{ animationDuration: "0.5s", animationFillMode: "forwards" }}
      >
        <div className="flex justify-between items-center p-4 border-b border-gray-700">
          <h3
            className={`text-2xl font-light text-color-modal-${theme} my-4 px-6`}
          >
            {title}
          </h3>
          <button
        ...
        <div
          className={`px-8 my-6 text-color-modal-${theme} font-light text-lg`}
        >
          {body}
        </div>
