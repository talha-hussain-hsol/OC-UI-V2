...
export default function SignIn() {
  ...
  const handleSignIn = async () => {
    ...
    let url = `${process.env.VITE_AUTH_API_URL}/oauth/authorize?client_id=${process.env.VITE_INVESTOR_CLIENT_ID}&redirect_uri=${process.env.INVESTOR_REDIRECT_URL}&scope=*&staet=${state}&response_type=${process.env.INVESTOR_RESPONSE_TYPE}`;
