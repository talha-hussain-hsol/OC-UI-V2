...
const DeleteAccountModal = ({
  ...
  const handleClickContinue = async () => {
    ...
    const response = await deleteCrp(selectedRow?.id, cancelTokenSource.token);
                ...
                <Row>
                  <Col xs={12} md={12}>
                    <Row>
                      <Col xs={12} md={12}>
                        <h3>
                          To confirm deletion of this {selectedRow?.label} crp,
                          click 'Proceed'. To cancel, click 'Cancel'.
                        </h3>
                      </Col>
                    </Row>
                    <div
