        ...
        <Col xs={12} md={6} lg={6} xl={6}>
          ...
          <div className="account_type_btn_container">
            <button
              ...
              className={
                isIndividualClick
                  ? "btn btn-primary btn-account-type-standalone selected"
                  : "btn btn-primary btn-account-type-standalone not_selected"
              }
            ...
            <button
              ...
              className={
                !isIndividualClick
                  ? "btn btn-primary btn-account-type-joint selected"
                  : "btn btn-primary btn-account-type-joint not_selected"
              }
