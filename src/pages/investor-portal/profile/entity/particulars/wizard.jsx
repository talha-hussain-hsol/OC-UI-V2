...
export default function Wizard() {
  ...
  useEffect(() => {
    console.log("jointAccountIsEnabled", jointAccountIsEnabled);
    ...
    <>
      <Row className="justify-content-center">
        <Col xs={12} md={10} lg={8} xl={6} className="text-center">
          ...
          <p className="mb-5 text-muted">
            Please verify the fund information before proceeding.
          </p>
        </Col>
      </Row>
      ...
      {isLoader ? (
        ...
        <div className="row">
          <div className="col-sm-6">
                ...
                >
                  <div className="form-group" style={{ width: "80%" }}>
                    ...
                    <Select
                      ...
                      defaultValue={selectedIdentityValue}
            ...
            {/* <div className="form-group">
          <label className="form-label">Select your Finance you want to attach to subscription request</label>
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <div style={{ marginLeft: "10px" }}>
              <a href="{{ route('user.profile.identity.list') }}" className="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top" title="Add Finance">
                <FeatherIcon
                    icon="plus" />
              </a>
            </div>
