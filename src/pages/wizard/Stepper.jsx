    ...
    const stepComponents = {
      ...
      "Identity Setup": (
        <UserForm
          ...
          identitiesData={selectedIdentity}
...
//       }
//     } else if (currentStep === steps.indexOf("Identity Setup") + 1) {
//       // Call handleNextClick from UserForm
//       if (userFormRef.current && userFormRef.current.handleNextClick) {
//         await userFormRef.current.handleNextClick();
//       }
//     }
//     if (currentStep < steps.length) {
//       setCurrentStep((prev) => prev + 1);
