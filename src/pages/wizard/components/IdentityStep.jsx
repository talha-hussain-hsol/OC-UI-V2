            ...
            result.forEach((item) => {
              ...
              if (
                ...
                if (registered_user_email) {
                  newState[key] = particularAddedData[`${props?.dataOfAccountSetup?.isIndividual ? 'individual'
                      : 'corporate'}.extended.email`] ? particularAddedData[`${props?.dataOfAccountSetup?.isIndividual ? 'individual'
    : 'corporate'}.extended.email`].value : registered_user_email;
                }
              }
            });
