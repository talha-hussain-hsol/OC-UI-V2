      ...
      <div>
        <div className="flex flex-col w-full justify-center">
          <Col xs={12} lg={12} xl={12}>
            ...
            <div
            className={`bg-color-card-${theme} rounded-md  shadow-${theme} mb-8 flex flex-col items-center justify-center h-full ml-8 mr-8 mt-10`}
          >
              {/* <div class="col-12 col-md-9"> */}
              <div className={checkIfShowAdditional() ? "col-9 col-md-9" : "w-full"}>
                {isLoader || isLoaderESign || isLoaderAccount ? <SpinnerWithBackDrop  /> : null}
                {/* {transactionData.length == 0 ? ( */}
                {isLoaderAccount ? (
                  <SpinnerWithBackDrop  />
                ) : (

                  <div className={`bg-color-card-${theme} shadow-${theme} border border-color-${theme} rounded-lg w-full`}>
                  <div className={`bg-color-card-${theme} rounded-t-md border-b-[1px] border-color-${theme} shadow-${theme} py-[18px] px-[16px] mb-6 flex justify-between items-center`}>
                    <h4 className={`font-light text-color-text-${theme}`}>Review & Sign Documents</h4>
                    {checkIfShowManualTransaction() && (
                      <Button
                        className={`bg-color-button3-${theme} hover:bg-color-button3-hover-${theme} transition-all duration-300 ease-in-out text-white font-light text-[15px] rounded-md py-2 px-4`}
                      ...
                      <div className={`bg-color-card-${theme} shadow-${theme} rounded-lg p-6`}>
                        ...
                        <form className="w-full flex flex-col gap-6">
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            <div>
                              <label className={`text-color-text-${theme} text-[15px] font-light mb-2 block`}>Type</label>
                              <select
                                className={`bg-color-textfield-dropdown-${theme} text-color-text-${theme} py-2 px-4 rounded-lg shadow-${theme} outline-none focus:ring-[1px] focus:ring-[#2b78da] w-full`}
                            ...
                            <div>
                              <label className={`text-color-text-${theme} text-[15px] font-light mb-2 block`}>Amount</label>
                              <input
                                type="number"
                                className={`bg-color-textfield-dropdown-${theme} text-color-text-${theme} py-2 px-4 rounded-lg shadow-${theme} outline-none focus:ring-[1px] focus:ring-[#2b78da] w-full`}
                                placeholder="Amount"
                            ...
                            <div>
                              <label className={`text-color-text-${theme} text-[15px] font-light mb-2 block`}>Currency</label>
                              <select
                                className={`bg-color-textfield-dropdown-${theme} text-color-text-${theme} py-2 px-4 rounded-lg shadow-${theme} outline-none focus:ring-[1px] focus:ring-[#2b78da] w-full`}
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                            <div>
                              <label className={`text-color-text-${theme} text-[15px] font-light mb-2 block`}>No Of Shares</label>
                              <input
                                type="number"
                                className={`bg-color-textfield-dropdown-${theme} text-color-text-${theme} py-2 px-4 rounded-lg shadow-${theme} outline-none focus:ring-[1px] focus:ring-[#2b78da] w-full`}
                            ...
                            <div>
                              <label className={`text-color-text-${theme} text-[15px] font-light mb-2 block`}>Class Type</label>
                              <select
                                className={`bg-color-textfield-dropdown-${theme} text-color-text-${theme} py-2 px-4 rounded-lg shadow-${theme} outline-none focus:ring-[1px] focus:ring-[#2b78da] w-full`}
                            ...
                            <div>
                              <label className={`text-color-text-${theme} text-[15px] font-light mb-2 block`}>Transaction Date</label>
                              <input
                                type="date"
                                className={`bg-color-textfield-dropdown-${theme} text-color-text-${theme} py-2 px-4 rounded-lg shadow-${theme} outline-none focus:ring-[1px] focus:ring-[#2b78da] w-full`}
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-4">
                            <div>
                              <label className={`text-color-text-${theme} text-[15px] font-light mb-2 block`}>Latest NAV Price</label>
                              <input
                                type="text"
                                className={`bg-color-textfield-dropdown-${theme} text-color-text-${theme} py-2 px-4 rounded-lg shadow-${theme} w-full`}
                            ...
                            <div>
                              <label className={`text-color-text-${theme} text-[15px] font-light mb-2 block`}>No Shares Owned</label>
                              <input
                                type="text"
                                className={`bg-color-textfield-dropdown-${theme} text-color-text-${theme} py-2 px-4 rounded-lg shadow-${theme} w-full`}
                          ...
                          <div className="flex justify-end mt-6">
                            <button
                              className={`bg-color-stepper-button-${theme} hover:bg-color-stepper-button-hover-${theme} transition-all duration-300 ease-in-out text-white font-medium text-[15px] rounded-lg py-3 px-7`}
        ...
        <tbody>
          {transactionHistoryData &&
            Object.keys(transactionHistoryData).map((item) => (
              ...
              <div className={`bg-color-card-${theme} border border-color-${theme} shadow-${theme} rounded-lg ml-8 mr-8`}>
                  <div className={`bg-color-card-${theme} rounded-t-md mb-6 border-b border-color-${theme} shadow-${theme} px-6 py-4 `}>
                    ...
                    <div className="w-full overflow-x-auto">
                      <table className="w-[97%] ml-4 mr-4 mb-4">
                        <thead className={`bg-color-table-color-${theme}`}>
                          <tr  className={` text-[#6e84a3] sm:text-[10px] text-[6px] text-left font-light uppercase border-color-${theme} border-b-[1px] `}
         >
                            <th className="px-4 py-2 ">Subscription Type</th>
                            <th className="px-4 py-2 ">Amount</th>
                            <th className="px-4 py-2 ">No of Shares</th>
                            <th className="px-4 py-2 ">Currency</th>
                            <th className="px-4 py-2 ">Status</th>
                            <th className="px-4 py-2">Date</th>

                            {checkIfStampingEnable() && <th className="px-4 py-2 ">Stamp</th>}
                            {props?.dataOfAccountSetup?.fundData?.region === "India" && checkIfESignEnable() && (
                              <th className="px-4 py-2 ">E Sign</th>
                            )}
