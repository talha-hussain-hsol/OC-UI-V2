    ...
    <div className="main-content">
      ...
      {item?.meta?.providerInfo?.provider === 'SIGN_DESK_PENNY_DROP' &&
        item?.meta?.providerInfo?.data?.status && (
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip>Penny Drop Details</Tooltip>}
          >
            <span>
              <FeatherIcon
                icon="list"
      ...
      {item?.meta?.providerInfo?.data?.status === null &&
        checkIfTimeExceededTenMins(
          ...
          <OverlayTrigger
            placement="top"
            overlay={<Tooltip>Verify Bank Identity</Tooltip>}
          >
            <span>
              <Button
                variant="primary"
      ...
      <OverlayTrigger
        placement="top"
        overlay={<Tooltip>Delete Bank Identity</Tooltip>}
      >
        <span>
          <FeatherIcon
            icon="trash"
      ...
      <OverlayTrigger
        placement="top"
        overlay={<Tooltip>View Bank Details</Tooltip>}
      >
        <span>
          <FeatherIcon
            icon="info"
