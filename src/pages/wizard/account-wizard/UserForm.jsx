...
// const UserForm = forwardRef({ userType, fundData, identitiesData, onFormChange, dataOfAccountSetups, fundId, updateDataOfAccountSetups, onNext }, ref) => {
//   const { theme } = useTheme();
//   const [formValues, setFormValues] = useState({});
//   const [newFields, setNewFields] = useState({});
//   const [isLoader, setIsLoader] = useState(true);
...
//   // Expose handleNextClick to parent component
...
//         data: updatedValues,
//         entity_type_id:
//           identitiesData?.type === "INDIVIDUAL" ? null : entityType?.toString() || null,
//       });
//     };
...
//     const getSpecificIdentity = async () => {
//       identity_id = "569c71f5-8944-4c01-b51a-ad2047e7ae27";
//       setIdentityId(identity_id);
//       setIsLoader(true);
//       const response = await getParticularsDetailByIdentityIdAPI(
