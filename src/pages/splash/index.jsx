...
const SplashScreen = () => {
  ...
  {/* Left side */}
  <div className="w-full h-screen lg:w-[40%] bg-gradient-to-r from-[#0c1f37] to-[#103649] p-8 text-white">
    <div className="mt-4 ml-6">
      ...
      <div className="overflow-y-auto max-h-96">
        {filteredEntities?.map((row, index) => {
          ...
          const meta = specificEntityData?.meta || specificEntityData?.entityMeta;
          const entityTitle =
            ...
            <div key={index} className="mb-3">
              <div className="flex items-center">
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm text-gray-400 font-light">{entityType}</p>
                </div>
              </div>
      ...
      {/* "Last Synced" button for small screens */}
  ...
  <div
    className="relative w-full lg:w-[60%] lg:bg-cover lg:bg-center bg-gradient-to-r from-[#0f3057] to-[#13203f]"
    style={{
      backgroundImage: `url('https://dev-portal.one-constellation.com/img/splash.jpg')`,
    }}
  >
    {/* "Last Synced" button for larger screens */}
    <div className="absolute top-0 left-0 w-full lg:static flex justify-end lg:items-start p-4 lg:bg-transparent bg-[#13203f]">
      <button className="hidden lg:block bg-blue-500 text-white font-light text-xs px-2 py-2 border border-black rounded-[15px]">
        Last Synced at: 3:58:43 PM <br />
        Synced
      </button>
    </div>
