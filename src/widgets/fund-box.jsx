            ...
            {fundData && (
              <div className="card">
                <div className="card-body text-center " >
                  <a href={fundData?.logoBucketKey} className=" avatar avatar-lg mx-auto display-flex-center">
                    <img style={{ height: "70px" }} src={fundData?.logoBucketKey ? fundData?.logoBucketKey : fundData?.fund_logo_url} />
                  ...
                  <p className="card-text text-muted">{fundData?.description}</p>
                </div>
                {fundData?.fund_setting?.display?.fund_info === true || fundData?.fund_setting?.display?.fund_info == "true" &&
                    ...
                    <div className="row align-items-center">
                      <div className="col">
                        <small>
                          ...
                          <FeatherIcon className={`text-success`} icon="clock" color="green" size="15" />
                          Dealing Cycle:  {fundData?.fund_setting?.dealing?.type?.end ? fundData?.fund_setting?.dealing?.type?.end : fundData?.fund_setting?.dealing?.type?.end}
                      ...
                      <div className="col-auto">
                        <small className="text-muted">
                          <span class="text-success">
                            <FeatherIcon className={`text-success`} icon="check-circle" color="green" size="15" />
                          </span>{" "}
                          Digital Fund:
                          {fundData?.fund_setting?.account?.applicant?.asset?.digital?.status
                            ? fundData?.fund_setting?.account?.applicant?.asset?.digital?.status
                              ? "Active"
                              : "Not Active"
                            : fundData?.meta?.config?.settings?.account?.applicant?.asset?.digital?.status
                              ? "Active"
                              : "Not Active"}
                        </small>
                      </div>
                    ...
                    <div className="row align-items-center">
                      <div className="col">
                        <small>
                          ...
                          Fund's KYC: {fundData?.fund_setting?.kyb?.status ? fundData?.fund_setting?.kyb?.status : fundData?.meta?.config?.kyb?.status}
                        </small>
                      </div>
                      <div className="col-auto">
                        <small className="text-muted">
                          ...
                          Fund Domicile:
                          {fundData?.fund_setting?.region ? fundData?.fund_setting?.region : fundData?.meta?.config?.settings?.region}
                        </small>
                        {/* <small>
                        Dealing Date{" "}
