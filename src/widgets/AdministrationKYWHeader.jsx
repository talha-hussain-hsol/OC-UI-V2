                ...
                <Row className="align-items-center">
                    <div className="col-auto">
                        ...
                        <div className="avatar avatar-md">
                            {fundDetail?.fund_logo_url && <img src={fundDetail?.fund_logo_url} alt="..." className="avatar-img rounded" />}
                        </div>
    ...
    Compliance Portal
                    ...
                    <Col xs="auto">
                        <h4 class="card-header-title">
                            ...
                            <img src="https://storage.googleapis.com/ascentfs-media-public/public-data/organizations/ascent-fs/logo/ascent-fs-logo.png" style={{ maxHeight: '35px', textAlign: 'left', marginLeft: '10px' }} alt="" class="rounded" />
                        </h4>
                    </Col>
                </Row>
                <Row style={{ marginTop: '15px', padding: '5px 0px' }}>
                    <Col>
                        <Breadcrumb>
                            <Breadcrumb.Item to="#!"><Link to='/'>Dashboard</Link></Breadcrumb.Item>
                            <FeatherIcon
                                icon="chevron-right"
                                size="1em"
                            />
                            <Breadcrumb.Item href="#!"><Link to={`/${params?.fund_id}/kyw/wallets/list`}>Wallet List</Link></Breadcrumb.Item>
                            <FeatherIcon
                                icon="chevron-right"
                                size="1em"
                            />
