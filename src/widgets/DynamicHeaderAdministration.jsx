...
import { isKYCEnabled, isKYWEnabled,isTransactionMonitoringEnabled,isRestrictedListEnabled } from "../helpers/getFundConfiguration";
...
export default function DynamicHeaderAdministration({ ...props }) {
  ...
  const isTMEnabledFundConfig = isTransactionMonitoringEnabled(fundConfig?.config); 
  const isRestrictedListEnabledFundConfig = isRestrictedListEnabled(fundConfig?.config); 
            ...
            {props?.isShowFundTabs ||
              (props?.isShowFundTabs == undefined && (
                <div className="col-auto">
                  ...
                  {isKYCEnabledinFundConfig &&  <li className="nav-item">
                      <Link
                    ...
                    { isKYWEnabledinFundConfig &&<li className="nav-item">
                      <Link
                    ...
                    {isTMEnabledFundConfig && <li className="nav-item">
                      <Link
                  ...
                  ( checkPermissions("RESTRICTED_LIST_READ") && (<li className="nav-item">
                      <Link
