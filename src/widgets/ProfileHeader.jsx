...
import { Col, Nav, Row, Button, Dropdown, Modal, Container, Form, Alert } from "react-bootstrap";
import Header from "../components/Header";
import { getRegistrationProviderForSingpass, postRegistrationProviderGetData } from "../api/network/CustomerApi";
...
export default function AccountHeader({ ...props }) {
  ...
  return (
    <Header className="mt-md-2" {...props}>
      ...
      {isLoader && <Loader animation="grow" custom={true} height="70vh" />}
      <Header.Body>
              ...
              {history.pathname === "/profile/info" ? (
                <Nav.Item>
                  <Link to="/profile/info" passHref>
                    <Nav.Link href="/profile/info" active={history.pathname === "/profile/info"}>
                      Info
                    </Nav.Link>
                  </Link>
                </Nav.Item>
              ...
              {history.pathname === "/profile/identities" ? (
                <Nav.Item>
                  <Link to="/profile/identities" passHref>
                    <Nav.Link href="/profile/identities" active={history.pathname === "/profile/identities"}>
                      My Identities
                    </Nav.Link>
                  </Link>
                </Nav.Item>
