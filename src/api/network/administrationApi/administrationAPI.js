...
export const getFilterFundsAPI = async (
  name,
  region,
  limit,
  offset,
  ...
  const url = `/${entityId}/${baseURL}/domain/summary?offset=${offset}&limit=${limit}${
...
export const getAccountListSearch = async (
  name,
  fundId,
  limit,
  offset,
...
export const getExpiredDocumentAPI = async (
  fundId,
  type,
  cancelToken,
  offset = 0,
...
export const getPeriodicReviewAPI = async (
  fundId,
  offset,
  limit,
  cancelToken,
...
export const getScreeningSummaryReport = async (
  fund_id,
  screening_id,
  cancelToken
) => {
...
export const getScreeningPreviousHistoryAPI = async (
  fund_id,
  identity_id,
  cancelToken
) => {
...
export const getRestrictedListCustomer = async (
  listId,
  offset,
  limit,
  cancelToken
...
export const getFlatCPRListAPI = async (
  identity_id,
  accountId,
  cancelToken
) => {
...
export const getAllFundTransactionAlertsAPI = async (
  fundId,
  limit,
  offset,
  cancelToken
...
export const getDownloadAuditReport = async (
  fund_id,
  account_id,
  cancelToken
) => {
...
export const getAgeingReportWithKey = async (
  key,
  currentDate,
  ageingReportType,
  cancelToken
...
export const getSanctionListReportDownload = async (
  fundId,
  id,
  identityId,
  cancelToken
...
export const getDownloadQuickScanReportAPI = async (
  fundId,
  screeningId,
  referenceId,
  cancelToken
...
export const DownloadQuickScanAllReportAPI = async (
  fundId,
  screeningId,
  engines,
  cancelToken
...
export const getScreeningSummaryReportPollingAPI = async (
  fundId,
  screeningId,
  key = null,
  cancelToken
...
export const submitCustomTransactionDataAPI = async (
  accountId,
  data,
  cancelToken
) => {
...
export const updateCustomTransactionDataAPI = async (
  accountId,
  data,
  cancelToken
) => {
...
export const getTranactionStatusList = async (
  accountId,
  transactionId,
  cancelToken
) => {
...
export const fetchExportDataForEntityOrIdentity = async (
  fundId,
  cancelToken
) => {
  // Construct the URL with fundId as a query parameter if it exists
  const url = `/${entityId}/${baseURL}/data-export${
...
export const fetchEntityReport = async (key, cancelToken) => {
  const url = key
    ? `/${entityId}/${baseURL}/data-export?key=${key}`
    : `/${entityId}/${baseURL}/data-export`;
...
export const fetchDomainReport = async (fundId, key, cancelToken) => {
  ...
  const url = !key
    ? `/${entityId}/${baseURL}/data-export?fund_id=${fundId}`
    : `/${entityId}/${baseURL}/data-export?fund_id=${fundId}&key=${key}`;
...
export const getCustomerInformationReport = async (
  identityId,
  fundId,
  cancelToken
) => {
