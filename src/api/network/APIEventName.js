export const APIEventName = {
  ...
  "organizations/ascent-fs/funds/demo/document-types":
    "GET_ORGANIZATION_DOCUMENT_TYPES",
  ...
  "/transaction/:id/download-sign-document":
    "GET_DOWNLOAD_TRANSACTION_SIGN_DOCUMENT",
  ...
  "/Identity/:id/AccountShareHolder/:id/FaceVerification":
    "POST_FACEVERIFICATION_DATA",
  "/Identity/:id/AccountShareHolder/:id/Vcip": "POST_VCIP_DATA",
  "/Identity/:id/AccountShareHolder/:id/Vcip/verifyUpload":
    "POST_VERIFY_VCIP_VIDEO",
  "/getDataSignedUrl": "GET_SIGNED_URL",
  "/:id/addBankAddress": "POST_BANK_DATA",
  "/Identity/:id/AccountShareHolder/:id/DocumentDigitalStamping":
    "POST_DOCUMENT_DIGITAL_STAMP",
  "/:id/getIdentityBankList": "GET_BANK_LIST",
  "/Identity/:id/AccountShareHolder/:id/DocumentAadhaarSigning":
    "POST_ESIGN_DATA",
  ...
  "/fund/:id/account/:id/application-history":
    "GET_APPLICATION_DOWNLOAD_HISTORY",
