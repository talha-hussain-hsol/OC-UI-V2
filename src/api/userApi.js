...
export const getIdentityList = async (cancelToken, fundId) => {
  let url;
  fundId
    ? (url = `/getCustomerIdentityList/CAPI/Identity/list?fundId=${fundId}`)
    : (url = `/getCustomerIdentityList/CAPI/Identity/list`);
...
//1
export const postStampingApi = async (
  identityId,
  accountShareHolderId,
  data,
  cancelToken
...
export const doStampingAPI = async (
  identityId,
  accountShareHolderId,
  data,
  cancelToken
...
export const validateByPennyDropVerifyAPI = async (
  identityId,
  data,
  cancelToken
) => {
