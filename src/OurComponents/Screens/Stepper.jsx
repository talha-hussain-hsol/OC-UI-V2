...
function Stepper() {
  ...
  return (
    <>
      ...
      >
        <ul className="relative flex flex-row lg:ml-14 lg:mt-7 md:mt-16 md:ml-0 md:mr-2 sm:mt-16 xs:mt-16 2xs:mt-16 sm:ml-0 xs:mt-16 xs:ml-4">
        ...
        >
          ...
          <div className="flex justify-center  sm:justify-between w-full p-4">
            <Button
              text="Back"
