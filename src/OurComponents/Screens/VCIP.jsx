...
function VCIP() {
  return (
    <>
          ...
          <div className="mt-2 border-b-4 border-[#043f63] px-4 ">
          ...
          <div className="flex flex-col lg:flex-row lg:space-x-8 mt-8 lg:mt-[74px] justify-center px-4 ">
            <div className="bg-[#062b4d] p-6 shadow-[5px_5px_15px_5px_rgba(0,0,0,0.3)] rounded-lg w-full lg:w-[70%]   mb-8 lg:mb-0">
            ...
            <div className="bg-[#062b4d] p-6 rounded-lg w-full lg:w-[34%]   shadow-[5px_5px_15px_5px_rgba(0,0,0,0.3)]">
              ...
              <Button
                ...
                className="bg-green-600 hover:bg-green-600 text-white py-4 lg:py-[20px] px-4 lg:px-8 rounded-[18px] mx-auto block mt-10 lg:mt-24"
              />
            </div>
          </div>
