      ...
      {accountData.map((account) => (
        ...
        >
          <div className="flex flex-col items-center gap-4">
            <CardHeader
              FundName={account.account.fund.name}
              logoUrl={account.account.fund.logoBucketKey}
                ...
                <MiniCards
                  leftContent={
                    <div className="flex flex-col gap-1">
                      <h3
                        className={`text-lg font-semibold text-color-${theme}`}
                      >
                      ...
                      <p className="text-[#6881a3] flex items-center gap-2">
                        Customer Type: {account.identity.type}
                        <FiCheckCircle color="#01cc7a" size={16} />
                      </p>
                      <p className={`text-color-${theme}`}>
                        Subscription Type:{" "}
                        {account.account.scount === 1
                          ? "Standalone"
                          : "Joint Account"}
                      </p>
                      <p className={`text-color-${theme}`}>
